                ...
                <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
                    <div>
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <a href="https://github.com/TheAlgoFlow/AlgoFlow" target="_blank" rel="noopener noreferrer" className="text-muted transition-all hover:text-foreground hover:scale-110" aria-label="GitHub">
                                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
