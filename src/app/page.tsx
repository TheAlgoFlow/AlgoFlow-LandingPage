      ...
      <div className="min-h-screen bg-white text-zinc-900 font-sans relative overflow-hidden">
        ...
        <header className={`fixed top-0 w-full z-50 px-24 pt-2 pb-6 flex items-center justify-between bg-transparent ${inter.className}`}>
          <div className="flex items-center gap-16">
            ...
            <nav className="hidden md:flex items-center gap-8 text-[14.5px] font-medium text-[#45474D]">
          ...
          <div className="flex items-center">
            <a href="https://github.com/TheAlgoFlow/AlgoFlow" target="_blank" rel="noopener noreferrer" className="bg-[#121317] text-white px-5 py-2.5 rounded-full text-[14px] font-medium hover:bg-zinc-800 shadow-md transition-all flex items-center gap-2 hover:scale-105">
              <svg viewBox="0 0 24 24" className="w-4 h-3 fill-current" xmlns="http://www.w3.org/2000/svg">
